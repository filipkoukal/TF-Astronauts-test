                ...
                <div class="flex flex-col ">
                    ...
                    <!-- dob -->
                        <div maxlength="20" id="modal-first-name" class="flex flex-col flex-1 px-6 py-3 text-left ">
                            ...
                            <input v-model="new_astronaut.date_of_birth" type="date" :class="{'border-red-500':fillErrors.date_of_birth}" class="p-2 mt-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <label v-if="fillErrors.date_of_birth" class="text-xs font-medium text-red-500 uppercase">Required field!</label>
                        </div>
                        ...
                        <div maxlength="200" id="modal-last-name" class="flex flex-col flex-1 px-6 py-3 text-left ">
                            ...
                            <input v-model="new_astronaut.superpower" type="text" :class="{'border-red-500':fillErrors.superpower}" class="p-2 mt-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" >
                            <label v-if="fillErrors.superpower" class="text-xs font-medium text-red-500 uppercase">Required field!</label>
...
import * as api from "../../constants/api";
  ...
  export default {
    ...
    methods: {
      ...
      checkValidity(){
        this.resetErrors()
        if (this.new_astronaut.first_name == "") this.fillErrors.first_name = true
        if (this.new_astronaut.last_name == "") this.fillErrors.last_name = true
        if (this.new_astronaut.date_of_birth == "") this.fillErrors.date_of_birth = true
        if (this.new_astronaut.superpower == "") this.fillErrors.superpower = true
      ...
      confirmAdd(){
        if(this.checkValidity()){
          this.axios.post(api.CREATE_ASTRONAUT, {
