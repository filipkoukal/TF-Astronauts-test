    ...
    <Transition name="delete-fade">
      <div v-if="isModalVisible">
        <div @click="onToggle" class="absolute bg-black opacity-70 inset-0 z-40"></div>
          ...
          <div class="w-full max-w-md p-3 mx-auto my-auto rounded-xl shadow-lg bg-gray-800 fixed top-1-3 left-0 right-0 z-50 text-gray-200">
          <div>

            <div class="text-center p-3 flex-auto justify-center leading-6">
              <h2 class="text-2xl font-bold py-4">Delete Astronaut {{ astronaut.first_name }} {{ astronaut.last_name }}</h2>
