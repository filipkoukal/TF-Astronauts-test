      ...
      >
        <div>
            ...
            <div class="flex flex-col ">
              ...
              <div class="flex-1 flex flex-row">
                ...
                >
                  ...
                  <p
                    class="py-2 whitespace-nowrap text-m font-medium text-gray-800 break-all"
                    v-if="!isEdit"
                  >
                  ...
                  <input
                    maxlength="20"
                    v-model="edited_astronaut.first_name"
                    type="text"
                    :class="{ 'border-red-500': editFillErrors.first_name }"
                  ...
                  />
                  <label
                    v-if="isEdit && editFillErrors.first_name"
                ...
                >
                  ...
                  <input
                    maxlength="20"
                    v-model="edited_astronaut.last_name"
                    type="text"
                    :class="{ 'border-red-500': editFillErrors.last_name }"
                    class="p-2 mt-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    v-else
                  />
                  <label
                    v-if="isEdit && editFillErrors.last_name"
                    class="text-xs font-medium text-red-500 uppercase"
                    >Required field!</label
                  >
                </div>
              ...
              <div class="flex-1  flex flex-row">
                ...
                >
                  ...
                  <p
                    class="py-2 whitespace-nowrap text-m font-medium text-gray-800 "
                    v-if="!isEdit"
                  >
                  ...
                  <input
                    maxlength="20"
                    v-model="edited_astronaut.date_of_birth"
                    type="date"
                    :class="{ 'border-red-500': editFillErrors.date_of_birth }"
                    class="p-2 mt-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    v-else
                  />
                  <label
                    v-if="isEdit && editFillErrors.date_of_birth"
                    class="text-xs font-medium text-red-500 uppercase"
                    >Required field!</label
                  >
                </div>
                ...
                >
                  ...
                  <p
                    class="py-2  text-m font-medium text-gray-800 break-all "
                    v-if="!isEdit"
                  >
                  ...
                  <input
                    maxlength="200"
                    v-model="edited_astronaut.superpower"
                    type="text"
                    :class="{ 'border-red-500': editFillErrors.superpower }"
                    class="p-2 mt-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    v-else
                  />
                  <label
                    v-if="isEdit && editFillErrors.superpower"
                    class="text-xs font-medium text-red-500 uppercase"
                    >Required field!</label
                  >
                </div>
          ...
          <div class="p-3 mt-2 text-right space-x-4 md:block" v-else>
            <button
              @click="confirmEdit"
              class="transition duration-150 ease-out hover:ease-in mb-2 md:mb-0 bg-blue-500 border border-blue-500 px-5 py-2 text-sm shadow-sm font-medium tracking-wider text-white rounded-md hover:shadow-lg hover:bg-blue-600"
            >
              Confirm
            </button>
            <button
...
<script>
// Component defining the astronaut details modal including editing
...
export default {
  ...
  methods: {
    ...
    checkValidity() {
      this.resetErrors();
      if (this.edited_astronaut.first_name == "")
        this.editFillErrors.first_name = true;
      if (this.edited_astronaut.last_name == "")
        this.editFillErrors.last_name = true;
      if (this.edited_astronaut.date_of_birth == "")
        this.editFillErrors.date_of_birth = true;
      if (this.edited_astronaut.superpower == "")
        this.editFillErrors.superpower = true;
    ...
    confirmEdit() {
      if (this.checkValidity()) {
        this.axios
          .put(api.EDIT_ASTRONAUT + this.astronaut.id, {
